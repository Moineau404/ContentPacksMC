package mod.moineau.contentpacks.api.resource;

import com.mojang.serialization.Codec;
import mod.moineau.contentpacks.client.resource.DependentReloadListener;
...
public final class CustomTextureReloadListener<T> extends DependentReloadListener<CustomTextureProvider<T>, Optional<Identifier>> {
