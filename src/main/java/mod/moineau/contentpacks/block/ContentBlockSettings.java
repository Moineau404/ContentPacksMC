...
public interface ContentBlockSettings {
    Function<BlockState, MapColor> DEFAULT_MAP_COLOR_PROVIDER = MapColorProvider.of(MapColor.CLEAR);
    ToIntFunction<BlockState> DEFAULT_LUMINANCE_PROVIDER = LuminanceProvider.of(0);
    AbstractBlock.TypedContextPredicate<EntityType<?>> DEFAULT_ALLOWS_SWPANING_PREDICATE = EntityTypedBlockContextPredicate.allOf(
            ...
            EntityTypedBlockContextPredicate.luminance(Comparison.lessThan(14)));
    ...
    AbstractBlock.ContextPredicate DEFAULT_SUFFOCATION_PREDICATE = BlockContextPredicate.allOf(
            BlockContextPredicate.blocksMovement(),
