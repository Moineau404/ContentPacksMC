...
public sealed abstract class LuminanceProvider implements ToIntFunction<BlockState> {
    public static final Codec<LuminanceProvider> CODEC = Codec.either(
    ...
    public static LuminanceProvider of(int value) {
        return new Constant(value);
    }

    public static LuminanceProvider of(VariantMap<Integer> variants) {
        return new Variant(variants);
    }

    public static final class Constant extends LuminanceProvider {
    ...
    public static final class Variant extends LuminanceProvider {
